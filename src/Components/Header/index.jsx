...
export default function Header({
  ...
  return (
    <div className={`w-full bg-white flex justify-between ${className}`}>
      <div className="p-4 flex items-center divide-x">
        {title && title.length ? (
          <div
            className="text-2xl  leading-6 pr-4"
        ...
        {startAdornment?.map((element, index) => (
